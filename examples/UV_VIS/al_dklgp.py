...
N_GP_ITERATIONS = 1000 # number of GP fitting iterations
N_LATENT = 2
N_COMPOSITION = 2
...
for i in range(N_QUERIES):
    ...
    gp_model, gp_loss = surrogates.train_dkl(i, N_LATENT,data, time, np_model, N_GP_ITERATIONS)
...
visuals.plot_phasemap_pred(sim, time, gp_model, np_model , SAVE_DIR+'final_compare.png')
...
visuals.plot_gpmodel_grid(ax, time, C_train, gp_model, np_model, show_sigma=False)
